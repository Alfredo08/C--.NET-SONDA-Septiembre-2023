...
public class DirectorController : Controller{
    ...
    public IActionResult Directores(){
                                            /* SELECT *
                                               FROM directores; */
        List<Director> ListaDirectoresLINQ = _context.Directores.Include(dir => dir.ListaPeliculas).ToList();
        foreach(Director dir in ListaDirectoresLINQ){
            Console.WriteLine(dir.Nombre);
            foreach(Pelicula peli in dir.ListaPeliculas){
        ...
        if(ModelState.IsValid){
            ...
            if(director != null){
                ...
                if(result != 0){
                    ...
                    HttpContext.Session.SetInt32("Id", director.DirectorId);
